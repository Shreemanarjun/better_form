...
void main() {
  group('BetterDependentField', () {
          ...
          child: MaterialApp(
            home: Scaffold(
              body: BetterForm(
                ...
                fields: [BetterFormFieldConfig(id: watchedField, initialValue: 'initial')],
    ...
    testWidgets('does not rebuild when unwatched field changes', (tester) async {
      final watchedField = BetterFormFieldID<String>('watched_field');
      ...
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            home: Scaffold(
              body: BetterForm(
                initialValue: const {'watched_field': 'initial', 'other_field': 'other'},
                fields: [
                  BetterFormFieldConfig(id: watchedField, initialValue: 'initial'),
      ...
      final provider = BetterForm.of(tester.element(find.text('Watched: initial')))!;
      final container = ProviderScope.containerOf(tester.element(find.text('Watched: initial')));
    ...
    testWidgets('works with different field types - int', (tester) async {
      ...
      final container = ProviderScope.containerOf(tester.element(find.text('Number: 42')));
    ...
    testWidgets('works with different field types - bool', (tester) async {
      ...
      // Change value
      final provider = BetterForm.of(tester.element(find.text('Boolean: true')))!;
      final container = ProviderScope.containerOf(tester.element(find.text('Boolean: true')));
    ...
    testWidgets('works with different field types - double', (tester) async {
          ...
          child: MaterialApp(
            home: Scaffold(
              body: BetterForm(
                ...
                fields: [BetterFormFieldConfig(id: doubleField, initialValue: 3.14)],
      ...
      // Change value
      final provider = BetterForm.of(tester.element(find.text('Double: 3.14')))!;
      final container = ProviderScope.containerOf(tester.element(find.text('Double: 3.14')));
    ...
    testWidgets('handles null values correctly', (tester) async {
      ...
      final container = ProviderScope.containerOf(tester.element(find.text('Value: null')));
    ...
    testWidgets('uses custom controller provider when provided', (tester) async {
      ...
      final customProvider = StateNotifierProvider.autoDispose<RiverpodFormController, FormState>((ref) {
        return RiverpodFormController(initialValue: {'custom_field': 'custom_value'});
      });
    ...
    testWidgets('falls back to BetterForm.of(context) when no controller provider', (tester) async {
          ...
          child: MaterialApp(
            home: Scaffold(
              body: BetterForm(
                ...
                fields: [BetterFormFieldConfig(id: contextField, initialValue: 'from_context')],
                child: BetterDependentField<String>(
    ...
    testWidgets('falls back to default provider when no context or custom provider', (tester) async {
        ...
        ProviderScope(
          overrides: [
            formControllerProvider(const BetterFormParameter(initialValue: {}))
                .overrideWith((ref) {
              return RiverpodFormController(initialValue: {'default_field': 'from_default'});
            }),
          ],
          child: MaterialApp(
            home: Scaffold(
          ...
          child: MaterialApp(
            home: Scaffold(
              body: BetterForm(
                ...
                fields: [BetterFormFieldConfig(id: contextField, initialValue: 'test')],
                child: BetterDependentField<String>(
                  fieldId: contextField,
                  builder: (context, value) {
                    // Test that we can access MediaQuery from context
                    final mediaQuery = MediaQuery.of(context);
                    // ignore: unnecessary_null_comparison
                    final hasMediaQuery = mediaQuery != null;
                    return Text('Has MediaQuery: $hasMediaQuery, Value: $value');
                  },
                ),
              ),
            ),
    ...
    testWidgets('handles complex data types', (tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            home: Scaffold(
              body: BetterForm(
                initialValue: const {'list_field': ['a', 'b', 'c']},
      ...
      // Change the list
      final provider = BetterForm.of(tester.element(find.text('List length: 3')))!;
      final container = ProviderScope.containerOf(tester.element(find.text('List length: 3')));
    ...
    testWidgets('works with enum-like string values', (tester) async {
          ...
          child: MaterialApp(
            home: Scaffold(
              body: BetterForm(
                ...
                fields: [BetterFormFieldConfig(id: statusField, initialValue: 'active')],
                child: BetterDependentField<String>(
                  fieldId: statusField,
                  builder: (context, value) {
      ...
      // Change status
      final provider = BetterForm.of(tester.element(find.text('Status: ACTIVE')))!;
      final container = ProviderScope.containerOf(tester.element(find.text('Status: ACTIVE')));
    ...
    testWidgets('handles rapid consecutive changes', (tester) async {
          ...
          child: MaterialApp(
            home: Scaffold(
              body: BetterForm(
                ...
                fields: [BetterFormFieldConfig(id: counterField, initialValue: 0)],
                child: BetterDependentField<int>(
      ...
      final container = ProviderScope.containerOf(tester.element(find.text('Count: 0')));
      ...
      expect(buildCount, greaterThanOrEqualTo(2)); // At least initial + final change
    });
    ...
    testWidgets('works with multiple dependent fields watching different fields', (tester) async {
      ...
      // Change field1
      final provider = BetterForm.of(tester.element(find.text('Field1: value1')))!;
      final container = ProviderScope.containerOf(tester.element(find.text('Field1: value1')));
    ...
    testWidgets('handles field removal gracefully', (tester) async {
          ...
          child: MaterialApp(
            home: Scaffold(
              body: BetterForm(
                ...
                fields: [BetterFormFieldConfig(id: tempField, initialValue: 'exists')],
                child: BetterDependentField<String>(
                  fieldId: tempField,
                  builder: (context, value) {
      ...
      // Remove the field
      final provider = BetterForm.of(tester.element(find.text('Temp: exists')))!;
      final container = ProviderScope.containerOf(tester.element(find.text('Temp: exists')));
      (container.read(provider.notifier) as BetterFormController).unregisterField(tempField);
